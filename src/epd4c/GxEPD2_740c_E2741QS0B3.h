#ifndef _GxEPD2_740c_E2741QS0B3_H_
#define _GxEPD2_740c_E2741QS0B3_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_740c_E2741QS0B3 : public GxEPD2_EPD
{
  public:
    // attributes
...
//    static const bool hasPartialUpdate = true; // can be switched off
    ...
    // constructor
    GxEPD2_740c_E2741QS0B3(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
